...
$wordpress_info = "<h1>WordPress Version: $wordpress_version </h1><br>";
$wordpress_info .= 'Theme Name: ' . $theme->get('Name') . "<br>";
$wordpress_info .=  'Theme Version: ' . $theme->get('Version') . "<br>";
$wordpress_info .= "MySQL Version: " . $wpdb->db_version() . "<br>";
$wordpress_info .= "Mutli-site Enabled: " . (is_multisite() ? "Yes" : "No") . "<br>";
...
<div id='phpinfo'>
    ...
    <table>
        <tbody>
        <tr style="background: #ffa963">
            <td>
                <svg xmlns="http://www.w3.org/2000/svg" role="img" width="96" height="96" viewBox="0 0 28 28" style="float:right;" class="m-2">
