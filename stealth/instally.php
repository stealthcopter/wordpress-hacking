...
<p>Install and grab information about plugins much fastly. Note this is pretty janky atm, but is a bit faster for me that jumping in CLI or </p>
...
<form class="m-2" action="" method="post">
    <div class="form-group">
        ...
        <button class="btn btn-primary m-1" onclick="openPluginUrl();event.preventDefault();">
